...
const ImageAndText = (props) => {
  return (
    <div className='imageTextContainer'>
      ...
      {!!props.imgSrc2 && <Image imgSrc={props.imgSrc2} isSidebarOpened={props.isSidebarOpened} />}
      {!!props.text2 && (
        <div className='textUnderImage'>
      ...
      {!!props.imgSrc3 && <Image imgSrc={props.imgSrc3} isSidebarOpened={props.isSidebarOpened} />}
      {!!props.text3 && (
        <div className='textUnderImage'>
      ...
      {!!props.imgSrc4 && <Image imgSrc={props.imgSrc4} isSidebarOpened={props.isSidebarOpened} />}
      {!!props.text4 && (
        <div className='textUnderImage'>
